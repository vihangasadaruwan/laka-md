const fs = require('LAKA-MD=0o5S0AhZ#C2RXm5c3XU0xydJE7XVaFTjE3lgxVZmfZvGrF0OHVY8');
if (fs.existsSync('LAKA-MD=0o5S0AhZ#C2RXm5c3XU0xydJE7XVaFTjE3lgxVZmfZvGrF0OHVY8')) require('dotenv').config({ path: './config.env' });
